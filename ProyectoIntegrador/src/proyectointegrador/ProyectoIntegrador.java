...
public class ProyectoIntegrador {
                    ...
                    do {
                        ...
                        if (turno == 1) {
                            try {
                                ...
                                pos2 = sc.next();
                                System.out.println("Ingrese la posicion de la pieza que desea comer, separado por una ','");
                                pos3 = sc.next();
                                ...
                                if ((int) Integer.parseInt(String.valueOf(tokens1[0])) > 18
                                        ...
                                        //--
                                        || (int) Integer.parseInt(String.valueOf(tokens3[0])) < 0
                                        || (int) Integer.parseInt(String.valueOf(tokens3[1])) < 0
                                        || (int) Integer.parseInt(String.valueOf(tokens3[0])) < 0
                                        || (int) Integer.parseInt(String.valueOf(tokens3[1])) < 0) {
                                ...
                                if ((int) Integer.parseInt(String.valueOf(tokens1[0]))
                                    ...
                                    if (r.movimiento(matriz1, (int) Integer.parseInt(String.valueOf(tokens1[0])),
                                        ...
                                        matriz = movimientoR(matriz1, (int) Integer.parseInt(String.valueOf(tokens1[0])),
                                                (int) Integer.parseInt(String.valueOf(tokens1[1])), (int) Integer.parseInt(String.valueOf(tokens2[0])),
                                                (int) Integer.parseInt(String.valueOf(tokens2[1])));
                                        // imprimirmatrizrecursiva(matriz,(int) Integer.parseInt(String.valueOf(tokens3[0])),(int) Integer.parseInt(String.valueOf(tokens3[1])));

                                       // imprimirmatrizrecursiva(matriz, 0, 0);
                                       // System.out.println("-----------");
                                       // System.out.println("#######" + d.comer(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))));
                                        
                                        if (matriz[(int)Integer.parseInt(String.valueOf(tokens3[0]))][(int) Integer.parseInt(String.valueOf(tokens3[0]))].equals("@")) {
                                           if (d.comerrey(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))) == true) {

                                           imprimirmatrizrecursiva(nuevamatrizrey(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))), 0, 0);
                                        } else {
                                            JOptionPane.showMessageDialog(null, "No hay cambios en la matriz, no se pudo comer");
                                        }
                                            
                                        }
                                     
                                           
                                        if (d.comer(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))) == true) {

                                           imprimirmatrizrecursiva(nuevamatrizr(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))), 0, 0);
                                        } else {
                                            JOptionPane.showMessageDialog(null, "No hay cambios en la matriz, no se pudo comer");
                                        }
                               ...
                               /*
                                 imprimirmatrizrecursiva(movimientoR(matriz1,Integer.parseInt(String.valueOf(pos1.charAt(0)))
                                ,Integer.parseInt(String.valueOf(pos1.charAt(2)))
                                        ,Integer.parseInt(String.valueOf(pos2.charAt(0)))
                                                ,Integer.parseInt(String.valueOf(pos2.charAt(2)))),0,0);
                                */
                                if (r.pierdenrebeldes(matriz)==false||r.pierdeelrey(matriz)==false||r.ganaelrey(matriz)==true) {
                                    
                                    if (r.pierdenrebeldes(matriz)==false) {
                                        JOptionPane.showMessageDialog(null, "Gano el rey y sus duques");
                                    }else if (r.pierdeelrey(matriz)==false) {
                                        JOptionPane.showMessageDialog(null, "Ganaron los rebeldes");
                                    }else if (r.ganaelrey(matriz)==true) {
                                        JOptionPane.showMessageDialog(null, "Gano el rey y sus duques");
                                    }
                                    resp='n';
                                    bandera=3;
                        ...
                        if (turno == 2) {
                            try {
                                ...
                                if ((int) Integer.parseInt(String.valueOf(tokens1[0]))
                                    ...
                                    if (d.movimiento(matriz1, (int) Integer.parseInt(String.valueOf(tokens1[0])),
                                            (int) Integer.parseInt(String.valueOf(tokens1[1])),
                                            (int) Integer.parseInt(String.valueOf(tokens2[0])),
                                            (int) Integer.parseInt(String.valueOf(tokens2[1]))) == false) {

                                        matriz = movimientoD(matriz1, (int) Integer.parseInt(String.valueOf(tokens1[0])),
                                                (int) Integer.parseInt(String.valueOf(tokens1[1])), (int) Integer.parseInt(String.valueOf(tokens2[0])),
                                                (int) Integer.parseInt(String.valueOf(tokens2[1])));
                                        // imprimirmatrizrecursiva(matriz,(int) Integer.parseInt(String.valueOf(tokens3[0])),(int) Integer.parseInt(String.valueOf(tokens3[1])));
                                        //imprimirmatrizrecursiva(matriz,0,0);
                                        ...
                                        //imprimirmatrizrecursiva(matriz, 0, 0);
                                       // System.out.println("-----------");
                                      // System.out.println("#######" + r.comer(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))));

                                       
                                       
                                         if (r.comer(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))) == true) {

                                            imprimirmatrizrecursiva(nuevamatrizd(matriz, (int) Integer.parseInt(String.valueOf(tokens3[0])), (int) Integer.parseInt(String.valueOf(tokens3[1]))), 0, 0);
                                        } else {
                                            JOptionPane.showMessageDialog(null, "No hay cambios en la matriz, no se pudo comer");
                                        }
    ...
    public static String[][] movimientoD(String[][] matriz, int x, int y, int nx, int ny) {

        if (matriz[x][y].equals("D")) {
            matriz[x][y] = " ";
            matriz[nx][ny] = "D";
        }else if (matriz[x][y].equals("@")) {
            matriz[x][y] = " ";
            matriz[nx][ny] = "@";
        }
    ...
    public static String[][] nuevamatrizr(String[][] matriz, int nx, int ny) {

        if (matriz[nx][ny].equals("D")) {
            matriz[nx][ny] = " ";
        }
     ...
     public static String[][] nuevamatrizrey(String[][] matriz, int nx, int ny) {
    ...
    public static String[][] nuevamatrizd(String[][] matriz, int nx, int ny) {

        if (matriz[nx][ny].equals("R")) {
            matriz[nx][ny] = " ";
        }
